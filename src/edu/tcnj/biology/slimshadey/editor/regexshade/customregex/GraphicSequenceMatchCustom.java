 ...
 */
public class GraphicSequenceMatchCustom extends Rectangle {
     ...
     * @param seqIndex
     */
    public GraphicSequenceMatchCustom(double x, double y, double width, double height, Color fill, String sequence, String accession, ArrayList<Integer> misMatchIndices, int seqIndex, int maxErr) {
